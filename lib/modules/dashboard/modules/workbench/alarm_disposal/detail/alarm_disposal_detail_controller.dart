...
/// 报警详情控制器。
class AlarmDisposalDetailController extends GetxController {
  ...
  String warningSourceText() {
    switch (source.warningSource) {
      case 1:
        return '设备';
      case 2:
        return '系统';
      case 3:
        return '人工';
      default:
        return source.warningSource <= 0 ? '--' : '来源${source.warningSource}';
    }
  }

  String disposalCategoryText() {
    switch (source.disposalCategory) {
      case 1:
        return '电话通知';
      case 2:
        return '现场处置';
      case 3:
        return '联动处置';
      default:
        return source.disposalCategory <= 0
            ? '--'
            : '类型${source.disposalCategory}';
    }
  }
}
