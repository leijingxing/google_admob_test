...
/// 预警处置控制器。
class WarningDisposalController extends GetxController {
  ...
  final List<WarningLevelOption> levelOptions = const [
    WarningLevelOption(label: '全部等级', value: null),
    WarningLevelOption(label: '红色', value: 1),
    WarningLevelOption(label: '橙色', value: 2),
    WarningLevelOption(label: '黄色', value: 3),
    WarningLevelOption(label: '蓝色', value: 4),
    WarningLevelOption(label: '无等级', value: 0),
  ];
...
class WarningLevelOption {
  final String label;
  final int? value;

  const WarningLevelOption({required this.label, required this.value});
}
