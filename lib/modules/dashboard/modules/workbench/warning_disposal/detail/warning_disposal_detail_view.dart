...
class WarningDisposalDetailView
  ...
  const WarningDisposalDetailView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<WarningDisposalDetailController>(
      builder: (logic) {
        final item = logic.source;
        return Scaffold(
          appBar: AppBar(title: const Text('预警详情')),
                    ...
                    children: [
                      ...
                      _InfoCard(
                        ...
                        lines: [
                          ...
                          _InfoLine(label: '预警状态', value: logic.statusText()),
                          _InfoLine(
                            label: '预警等级',
