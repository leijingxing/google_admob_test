...
part 'risk_warning_record_item_model.g.dart';

/// 违规记录列表项模型。
@JsonSerializable()
class RiskWarningRecordItemModel {
  ...
  const RiskWarningRecordItemModel({
    this.id,
    this.companyId,
    this.companyCode,
    this.companyName,
  ...
  factory RiskWarningRecordItemModel.fromJson(Map<String, dynamic> json) =>
      _$RiskWarningRecordItemModelFromJson(json);

  Map<String, dynamic> toJson() => _$RiskWarningRecordItemModelToJson(this);
}
